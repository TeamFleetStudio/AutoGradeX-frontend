...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    logger.info("Contact form submitted", { email: formData.email, subject: formData.subject });
    setSubmitted(true);
  };
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">support@autogradex.com</p>
                    <p className="text-slate-600">sales@autogradex.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Weekend: Email support only</p>
                  </div>
                </div>
              </div>
